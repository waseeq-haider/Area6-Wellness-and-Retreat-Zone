...
const locationDetails = [
  ...
  {
    icon: Route,
    title: "Near Water Bodies",
    description: "Situated near water bodies and gentle slopes for a serene environment."
  },
  {
    icon: TreePine,
    title: "RANGERS OVERLAY Zone",
    description: "Partially within RANGERS OVERLAY for protected natural beauty."
  }
];
